var QianQi2Layer = cc.Layer.extend({
    ...
    init:function () {
        ...
        var bgSp = cc.Sprite.create(g_res.img.sce_qia_temp[2]);
        ...
        var look_spNormal = cc.Node.create();
        look_spNormal.setContentSize(609, 560);
        var look_spSelected = cc.Node.create();
        look_spSelected.setContentSize(609, 560);
        var look_item = cc.MenuItemSprite.create(look_spNormal, look_spSelected,  function() {
            g_ScenesQ.push(QianQi2Scene);
            var newScene = new QianQi3Scene();
            g_director.replaceScene(newScene);
        }, this);
        look_item.setAnchorPoint(0, 0);
        look_item.setPosition(393, 67);

        var menu = cc.Menu.create(back_item, look_item);
...
var QianQi2Scene = cc.Scene.extend({
    ctor:function() {
        this._super();
